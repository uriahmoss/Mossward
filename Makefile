...
test-postgres:
	GOCACHE=$(GOCACHE) go test -race ./internal/store -run '^TestPostgreSQL(Migrations|ScanAndAsset|LocalAuth|SessionAndInvitation|WebAuthn|OIDC|ScopeAndPolicy|EndpointIdentity|EndpointInventory|EndpointIntegrity|EndpointNetwork|Relay)' -count=1
