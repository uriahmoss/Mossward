...
func TestIdentitySchemaMigrationCreatesSecurityTables(t *testing.T) {
	...
	for _, table := range []string{
		...
		"asset_services", "asset_service_events",
		"asset_evidence",
		"asset_aging_settings",
		"scanner_worker_enrollment_tokens", "scanner_workers",
		"scanner_worker_jobs",
		"scanner_worker_evidence_batches",
		"scanner_worker_job_checkpoints",
		"scanner_worker_job_dead_letters",
	} {
		var found string
