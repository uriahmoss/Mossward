...
const reusablePolicySelect = `SELECT id,name,scope_policy_id,ports,enabled,created_at,updated_at,schedule_kind,schedule_expression,schedule_timezone,window_start,window_end,run_missed,long_run_alert_seconds,next_run_at,last_scheduled_at,rate_limit_per_second,execution_mode,worker_site_id FROM reusable_scan_policies`
